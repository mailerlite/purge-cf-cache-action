...
ARG BASE_IMAGE=europe-docker.pkg.dev/mailerlitehub/base-images/go:go-v1.0.8-1.26
...
FROM europe-docker.pkg.dev/mailerlitehub/base-images/base:base-v1.0.14
